...
export function AdminLayout() {
  ...
  const navItems = [
    ...
    { icon: Plus, label: 'Create Hackathon', path: '/admin/create' },
    { icon: Settings, label: 'Manage', path: '/admin/manage' },
    { icon: Trophy, label: 'Leaderboard', path: '/admin/leaderboard' },
    { icon: Gavel, label: 'Judging', path: '/admin/judging' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0f] via-[#12121a] to-[#0a0a0f] text-white">
      ...
      <motion.aside
        initial={{ x: -300 }}
        animate={{ x: 0 }}
        className="fixed left-0 top-0 h-screen w-64 border-r border-white/10 bg-black/40 backdrop-blur-xl z-50"
      >
        <div className="p-6">
          {/* Logo */}
